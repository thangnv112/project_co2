...
# -*- coding: utf-8 -*-
"""
CO2 Monitoring Server for Raspberry Pi 5
...
TELEGRAM_BOT_TOKEN = '8249813011:AAGPqb9FH5NzipWUGzXQ9HJrRfJqr64HKbs'
TELEGRAM_CHAT_ID = '6454016619'
...
class DatabaseManager:
    ...
    def insert_sensor_data(self, co2, temperature, humidity):
        try:
            cursor = self.connection.cursor()
            cursor.execute(
                "INSERT INTO sensor_data (co2, temperature, humidity) VALUES (?, ?, ?)",
    ...
    def update_thresholds(self, new_thresholds):
        try:
            ...
            cursor.execute("""
                INSERT INTO thresholds (co2_max, temp_min, temp_max, humidity_min, humidity_max)
                VALUES (?, ?, ?, ?, ?)
            """, (
                new_thresholds['co2_max'],
...
def check_thresholds_and_alert(co2, temperature, humidity):
    ...
    # Kiểm tra CO₂
    if co2 > thresholds['co2_max']:
        alert_key = 'co2_high'
        if alert_key not in last_alert_time or \
           (current_time - last_alert_time[alert_key]).seconds > 300:  # 5 phút
            
            message = f"⚠️ CO₂ quá cao: {co2} ppm (Ngưỡng: {thresholds['co2_max']} ppm)\n"
            message += "💨 Khuyến nghị: Mở cửa sổ hoặc tăng thông gió!"
            
            send_telegram_alert(message)
            db.log_alert('co2_high', message, co2, thresholds['co2_max'])
            last_alert_time[alert_key] = current_time
            
            alerts.append({
                'type': 'co2_high',
                'message': f'CO₂ cao: {co2} ppm',
                'severity': 'danger'
            })
...
def on_message(client, userdata, msg):
    try:
        ...
        # Lưu vào database
        db.insert_sensor_data(co2, temperature, humidity)
        
        # Kiểm tra ngưỡng và cảnh báo
        alerts = check_thresholds_and_alert(co2, temperature, humidity)
        ...
        logger.info(f"Nhận dữ liệu: CO₂={co2}ppm, T={temperature}°C, H={humidity}%")
...
<head>
    ...
    <style>
        * {
        ...
        .co2-card { border-left: 5px solid #FF6B6B; }
...
<body>
    ...
    <div class="container">
        ...
        <div class="sensors-grid">
            <!-- CO₂ Card -->
            <div class="card sensor-card co2-card">
                <h3><span class="icon">💨</span> Nồng độ CO₂</h3>
                <div class="sensor-value" id="co2Value">
                    0<span class="sensor-unit">ppm</span>
                </div>
                <div class="sensor-status status-normal" id="co2Status">Bình thường</div>
            </div>
                ...
                <form id="thresholdForm">
                    <div class="form-row">
                        <div class="form-control">
                            <label for="co2Max">CO₂ tối đa (ppm)</label>
                            <input type="number" id="co2Max" name="co2_max" value="1000" min="400" max="5000" step="50">
                        </div>
                        <div class="form-control">
    ...
    <script>
        ...
        function updateSensorDisplay(data) {
            ...
            document.getElementById('co2Value').innerHTML = 
                `${data.co2}<span class="sensor-unit">ppm</span>`;
            ...
            // Cập nhật trạng thái
            updateSensorStatus('co2', data.co2);
        ...
        function updateChart(data) {
            ...
            chartData.co2Data.push(data.co2);
            ...
            sensorChart.data.datasets[0].data = chartData.co2Data;
                ...
                .then(data => {
                    ...
                    if (data && data.length > 0) {
                        ...
                        recentData.forEach(item => {
                            ...
                            chartData.co2Data.push(item.co2);
        ...
        function updateThresholdForm(thresholds) {
            document.getElementById('co2Max').value = thresholds.co2_max;
...
def api_thresholds():
    if request.method == 'POST':
        try:
            ...
            # Validate dữ liệu
            required_keys = ['co2_max', 'temp_min', 'temp_max', 'humidity_min', 'humidity_max']
...
if __name__ == '__main__':
    ...
    logger.info("🚀 Khởi động CO₂ Monitoring Server...")
